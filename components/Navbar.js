...
<nav class="">
  <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
    <div class="relative flex items-center justify-between h-16">
      <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
        {/* <!-- Mobile menu button--> */}
        <button
          className='inline-flex p-3 ml-auto text-black rounded outline-none hover:bg-blue-600 lg:hidden hover:text-black'
          onClick={handleClick}
        >
          <svg
            className='w-6 h-6'
      ...
      <div class="flex-1 flex items-center  sm:items-stretch sm:justify-start">
        <div class=" mx-10  sm:text-center ">
         E.Shop..
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        <button type="button" class="mx-2 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
          <span class="sr-only">search</span>
          {/* <!-- Heroicon name: search bar --> */}
  ...
  <div class="sm:hidden" id="mobile-menu">
    <div class="px-2 pt-2 pb-3 space-y-1">
      ...
      <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Project</a>
